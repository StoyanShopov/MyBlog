...
#pragma warning restore SA1413 // Use trailing comma in multi-line initializers
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParrentCommentId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostLike_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostsCategories", x => new { x.CategoryId, x.PostId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostLike_ApplicationUserId",
                table: "PostLike",
                column: "ApplicationUserId");
